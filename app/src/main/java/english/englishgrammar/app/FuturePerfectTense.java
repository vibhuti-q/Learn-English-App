...
public class FuturePerfectTense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Banner AD
        LxiMyPreferenceManager myPreferenceManagerdude = new LxiMyPreferenceManager(FuturePerfectTense.this);
        NaxleApps adsGlobalClassEveryTimedude = new NaxleApps();

        adsGlobalClassEveryTimedude.showBannerAdlxi(FuturePerfectTense.this, new LxiadmobCloseEvent() {
                    @Override
    ...
    public void favbtn(View view){
        ...
        adsGlobalClassEveryTimeslxi.showIntrestrialAdslxi(FuturePerfectTense.this, new LxiadmobCloseEvent() {
            @Override
            public void setFailedlxi() {
        ...
        }, new LxiMyPreferenceManager(FuturePerfectTense.this).fIdlxi());

    }
    @Override
    protected void onResume() {
        super.onResume();
        NaxleApps.setAdShowDialogslxi(FuturePerfectTense.this);
    }
