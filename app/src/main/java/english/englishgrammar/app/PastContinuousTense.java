...
public class PastContinuousTense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LxiMyPreferenceManager myPreferenceManagerdude = new LxiMyPreferenceManager(PastContinuousTense.this);
        NaxleApps adsGlobalClassEveryTimedude = new NaxleApps();

        adsGlobalClassEveryTimedude.showBannerAdlxi(PastContinuousTense.this, new LxiadmobCloseEvent() {
                    @Override
        ...
        defbtnon.setOnClickListener(view -> {
        ...
        defbtnoff.setOnClickListener(view -> {
        ...
        methodbtnon.setOnClickListener(view -> {
        ...
        methodbtnoff.setOnClickListener(view -> {
    ...
    public void favbtn(View view) {
        ...
        adsGlobalClassEveryTimeslxi.showIntrestrialAdslxi(PastContinuousTense.this, new LxiadmobCloseEvent() {
            @Override
            public void setFailedlxi() {
        ...
        }, new LxiMyPreferenceManager(PastContinuousTense.this).fIdlxi());
    }

    @Override
    protected void onResume() {
        super.onResume();
        NaxleApps.setAdShowDialogslxi(PastContinuousTense.this);
    }
