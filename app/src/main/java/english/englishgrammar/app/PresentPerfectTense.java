...
public class PresentPerfectTense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LxiMyPreferenceManager myPreferenceManagerdude = new LxiMyPreferenceManager(PresentPerfectTense.this);
        NaxleApps adsGlobalClassEveryTimedude = new NaxleApps();




        adsGlobalClassEveryTimedude.showBannerAdlxi(PresentPerfectTense.this, new LxiadmobCloseEvent() {
                    @Override
    ...
    public void favbtn(View view) {
        ...
        adsGlobalClassEveryTimeslxi.showIntrestrialAdslxi(PresentPerfectTense.this, new LxiadmobCloseEvent() {
            @Override
            public void setFailedlxi() {
        ...
        }, new LxiMyPreferenceManager(PresentPerfectTense.this).fIdlxi());
    }

    @Override
    protected void onResume() {
        super.onResume();
        NaxleApps.setAdShowDialogslxi(PresentPerfectTense.this);
    }
