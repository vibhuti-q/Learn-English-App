...
public class PresentContinuousTense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LxiMyPreferenceManager myPreferenceManagerdude = new LxiMyPreferenceManager(PresentContinuousTense.this);
        NaxleApps adsGlobalClassEveryTimedude = new NaxleApps();

        adsGlobalClassEveryTimedude.showBannerAdlxi(PresentContinuousTense.this, new LxiadmobCloseEvent() {
                    @Override
    ...
    public void favbtn(View view) {
        ...
        adsGlobalClassEveryTimeslxi.showIntrestrialAdslxi(PresentContinuousTense.this, new LxiadmobCloseEvent() {
            @Override
            public void setFailedlxi() {
        ...
        }, new LxiMyPreferenceManager(PresentContinuousTense.this).fIdlxi());
    }

    @Override
    protected void onResume() {
        super.onResume();
        NaxleApps.setAdShowDialogslxi(PresentContinuousTense.this);
    }
