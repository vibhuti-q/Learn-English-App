...
public class PresentPerfectContinuousTense extends AppCompatActivity {
    ...
    ImageButton backBtn;    Conversation_DBManager dbManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LxiMyPreferenceManager myPreferenceManagerdude = new LxiMyPreferenceManager(PresentPerfectContinuousTense.this);
        NaxleApps adsGlobalClassEveryTimedude = new NaxleApps();




        adsGlobalClassEveryTimedude.showBannerAdlxi(PresentPerfectContinuousTense.this, new LxiadmobCloseEvent() {
                    @Override
    ...
    public void favbtn(View view){
        ...
        adsGlobalClassEveryTimeslxi.showIntrestrialAdslxi(PresentPerfectContinuousTense.this, new LxiadmobCloseEvent() {
            @Override
            public void setFailedlxi() {
        ...
        }, new LxiMyPreferenceManager(PresentPerfectContinuousTense.this).fIdlxi());
  }

    @Override
    protected void onResume() {
        super.onResume();
        NaxleApps.setAdShowDialogslxi(PresentPerfectContinuousTense.this);
    }
