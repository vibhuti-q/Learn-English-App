...
public class PastPerfectContinuousTense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Banner AD
        LxiMyPreferenceManager myPreferenceManagerdude = new LxiMyPreferenceManager(PastPerfectContinuousTense.this);
        NaxleApps adsGlobalClassEveryTimedude = new NaxleApps();

        adsGlobalClassEveryTimedude.showBannerAdlxi(PastPerfectContinuousTense.this, new LxiadmobCloseEvent() {
                    @Override
    ...
    public void favbtn(View view) {
        ...
        adsGlobalClassEveryTimeslxi.showIntrestrialAdslxi(PastPerfectContinuousTense.this, new LxiadmobCloseEvent() {
            @Override
            public void setFailedlxi() {
        ...
        }, new LxiMyPreferenceManager(PastPerfectContinuousTense.this).fIdlxi());
    }

    @Override
    protected void onResume() {
        super.onResume();
        NaxleApps.setAdShowDialogslxi(PastPerfectContinuousTense.this);
    }
