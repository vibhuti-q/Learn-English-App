...
public class PastPerfectTense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LxiMyPreferenceManager myPreferenceManagerdude = new LxiMyPreferenceManager(PastPerfectTense.this);
        NaxleApps adsGlobalClassEveryTimedude = new NaxleApps();


        adsGlobalClassEveryTimedude.showBannerAdlxi(PastPerfectTense.this, new LxiadmobCloseEvent() {
                    @Override
    ...
    public void favbtn(View view) {
        ...
        adsGlobalClassEveryTimeslxi.showIntrestrialAdslxi(PastPerfectTense.this, new LxiadmobCloseEvent() {
            @Override
            public void setFailedlxi() {
        ...
        }, new LxiMyPreferenceManager(PastPerfectTense.this).fIdlxi());
    }

    @Override
    protected void onResume() {
        super.onResume();
        NaxleApps.setAdShowDialogslxi(PastPerfectTense.this);
    }
