package english.englishgrammar.app.Dic.data.repository;
...
import english.englishgrammar.app.Dic.data.local.AppDatabase;
import english.englishgrammar.app.Dic.data.local.WordsDao;
import english.englishgrammar.app.Dic.data.model.wordsapi.Word;
import english.englishgrammar.app.Dic.data.remote.wordsapi.WordsApiService;
...
public class WordsRepo {
  ...
  // find if word exists in list of favourite words
    ...
    private static class removeListAsyncTask extends AsyncTask<List<Word>, Void, Boolean>{
        private final Dic_MainActivity.OnRemoveSelectedWords mListener;
        private final WordsDao mAsyncTaskDao;
        removeListAsyncTask(Dic_MainActivity.OnRemoveSelectedWords mListener, WordsDao dao) {
