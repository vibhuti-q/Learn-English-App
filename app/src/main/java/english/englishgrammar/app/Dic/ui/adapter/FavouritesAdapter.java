package english.englishgrammar.app.Dic.ui.adapter;

import static english.englishgrammar.app.Dic.ui.main.Dic_MainActivity.ll;
...
public class FavouritesAdapter extends RecyclerView.Adapter<FavouritesAdapter.ViewHolder> {
    ...
    public void setFavWordsList(List<Word> list) {
        ...
        if (listFavWords.size() != 0) {
            Log.e("vibhuti","vibhuti"+listFavWords.size());
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.dic_favourite_item, parent, false);
