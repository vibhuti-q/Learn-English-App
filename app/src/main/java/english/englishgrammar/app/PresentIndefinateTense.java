...
public class PresentIndefinateTense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LxiMyPreferenceManager myPreferenceManagerdude = new LxiMyPreferenceManager(PresentIndefinateTense.this);
        NaxleApps adsGlobalClassEveryTimedude = new NaxleApps();

        adsGlobalClassEveryTimedude.showBannerAdlxi(PresentIndefinateTense.this, new LxiadmobCloseEvent() {
                    @Override
        ...
        defbtnon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!textToSpeech.isSpeaking()) {
                    ...
                    textToSpeech.playSilence(duration, TextToSpeech.QUEUE_FLUSH, null);
    ...
    public void favbtn(View view) {
        ...
        adsGlobalClassEveryTimeslxi.showIntrestrialAdslxi(PresentIndefinateTense.this, new LxiadmobCloseEvent() {
            @Override
            public void setFailedlxi() {
        ...
        }, new LxiMyPreferenceManager(PresentIndefinateTense.this).fIdlxi());
    }

    @Override
    protected void onResume() {
        super.onResume();
        NaxleApps.setAdShowDialogslxi(PresentIndefinateTense.this);
    }
}
