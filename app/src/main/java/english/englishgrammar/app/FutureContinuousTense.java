...
public class FutureContinuousTense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Banner AD
        LxiMyPreferenceManager myPreferenceManagerdude = new LxiMyPreferenceManager(FutureContinuousTense.this);
        NaxleApps adsGlobalClassEveryTimedude = new NaxleApps();

        adsGlobalClassEveryTimedude.showBannerAdlxi(FutureContinuousTense.this, new LxiadmobCloseEvent() {
                    @Override
    ...
    public void favbtn(View view) {
        ...
        adsGlobalClassEveryTimeslxi.showIntrestrialAdslxi(FutureContinuousTense.this, new LxiadmobCloseEvent() {
            @Override
            public void setFailedlxi() {
        ...
        }, new LxiMyPreferenceManager(FutureContinuousTense.this).fIdlxi());
    ...
    protected void onResume() {
        super.onResume();
        NaxleApps.setAdShowDialogslxi(FutureContinuousTense.this);
    }
