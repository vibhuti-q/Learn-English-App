...
public class FutureIndefinateTense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Banner AD
        LxiMyPreferenceManager myPreferenceManagerdude = new LxiMyPreferenceManager(FutureIndefinateTense.this);
        NaxleApps adsGlobalClassEveryTimedude = new NaxleApps();

        adsGlobalClassEveryTimedude.showBannerAdlxi(FutureIndefinateTense.this, new LxiadmobCloseEvent() {
                    @Override
    ...
    public void favbtn(View view){
        ...
        adsGlobalClassEveryTimeslxi.showIntrestrialAdslxi(FutureIndefinateTense.this, new LxiadmobCloseEvent() {
            @Override
            public void setFailedlxi() {
        ...
        }, new LxiMyPreferenceManager(FutureIndefinateTense.this).fIdlxi());

    }
    @Override
    protected void onResume() {
        super.onResume();
        NaxleApps.setAdShowDialogslxi(FutureIndefinateTense.this);
    }
